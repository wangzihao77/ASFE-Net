...
if __name__ == '__main__':
    base_dir = '/Users/apple/Desktop/randla-net-tf2-update/data/S3DIS/result'
    original_data_dir = '/Users/apple/Desktop/randla-net-tf2-update/data/S3DIS/original_ply'
